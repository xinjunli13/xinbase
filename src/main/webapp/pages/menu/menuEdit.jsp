			...
			<div class="content col-md-10">
				...
				<div class="container-fluid">
					<div class="row-fluid">
						<!-- well嵌入的效果 -->
						<div class="">
							<form action="<%=rootPath%>/menus/updateMenu" method="post" class="form-horizontal" enctype="multipart/form-data">
								<div class="row-fluid">
									<div class="col-md-6">
									...
									<div class="col-md-5">
											<div class="thumbnail" style="width:220px;height:170px">
												...
												<img alt="yyy" src="<%=rootPath%>/images/${menu.imgName }" style="width:220px;height:170px">
											</div>
